...
1. Na raiz do projeto, execute o comando `pnpm add cypress --save-dev`.
2. Execute o comando `pnpm cypress open` para abrir o Cypress pela primeira vez, o ambiente e2e de testes já está configurado.
3. Este será o ambiente de testes Cypress, antes de iniciar os testes feche o _Cypress_App_ e faça a leitura das instruções abaixo.
